 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              <h6> <span className="text-uppercase color">Introduction</span></h6>
              <Reveal className='onStep' keyframes={fadeInUp} delay={300} duration={900} triggerOnce>
              <h1 className="col-white">Hi, I'm Idea Phakpaphon</h1>
              </Reveal>
              ...
              <div className="row">
                  ...
                  <div className="row">
                          ...
                          <div className="col-lg-4 col-md-6 col-sm-4 mb30">
                              <div className="de_count text-left">
                                  <h3><span>3</span>k</h3>
                                  <h5 className="id-color">Achievement</h5>
                              </div>
                          </div>
                          ...
                          <div className="col-lg-4 col-md-6 col-sm-4 mb30">
                              <div className="de_count text-left">
                                  <h3><span>4</span>k</h3>
                                  <h5 className="id-color">Production</h5>
                              </div>
                          </div>
                      </div>
              </div>
